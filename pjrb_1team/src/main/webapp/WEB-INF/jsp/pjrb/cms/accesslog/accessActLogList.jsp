 ...
 ******************************************************** */
 ...
 function fnLinkPage(pageNo){
	...
	document.articleForm.action = "<c:url value='/cms/accesslog/accessActLogList.do'/>";
			...
			<div class="page-title-box">
				<div class="page-title-right">
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">접근 로그</li>
					</ol>
				</div>
				<h4 class="page-title">접근 로그</h4>
			</div>
		</div>
	</div>
	<!-- end page title -->
							...
							<table class="table mb-0 table-hover">
								<thead class="thead-dark">
									<tr>
										...
										<th scope="col">URL</th>
										<th scope="col">접근 내역</th>
										<th scope="col">파일 ID</th>
										<th scope="col">접근 일시</th>
									</tr>
								</thead>
								<tbody>
