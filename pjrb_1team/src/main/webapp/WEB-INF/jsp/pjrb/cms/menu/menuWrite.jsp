...
function fn_submit(){
	...
	frm.action = '<c:url value="/cms/menu/menuInsert.do"/>';
	frm.submit();
}

function fn_insertUrlSelf()
{
	$("input[name='menuUrl']").attr("readonly",false);
}
...
<input type="hidden" name="parentMenuId" value='<c:out value="${menuVO.parentMenuId }"/>'>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input type="text" name="menuTitle" class="form-control" required>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" name="menuDesc" class="form-control" required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            <label>메뉴 콘텐츠</label>
            <input type="text" name="menuUrl" id="menuUrl" class="form-control" readonly>
          </div>
        </div>
        <div class="col-lg-2">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="mngDepart" readonly value="">
          </div>
        </div>
        <div class="col-lg-2">
          <div class="form-group">
            <label>담당자</label>
            <input type="text" class="form-control" id="mngName" readonly value="">
          </div>
        </div>
        <div class="col-lg-3">
          <div class="form-group">
            <label>담당자(연락처)</label>
            <input type="text" class="form-control" id="mngPhone" readonly value="">
          </div>
        </div>
        <div class="col-lg-2">
          <div class="form-group">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isBlankRadio1" name="isBlank" class="custom-control-input" value="N" checked>
              <label class="custom-control-label" for="isBlankRadio1"><span>페이지 이동</span></label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isBlankRadio2" name="isBlank" class="custom-control-input" value="Y">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isRmouseRadio1" name="isRmouse" class="custom-control-input" value="Y" checked>
              <label class="custom-control-label" for="isRmouseRadio1"><span>허용</span></label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isRmouseRadio2" name="isRmouse" class="custom-control-input" value="N">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isUseRadio1" name="menuUse" class="custom-control-input" value="Y" checked>
              <label class="custom-control-label" for="isUseRadio1"><span>사용</span></label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="isUseRadio2" name="menuUse" class="custom-control-input" value="N">
