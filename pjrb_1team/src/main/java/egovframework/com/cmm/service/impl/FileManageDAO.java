...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	public List<?> selectFileMngList(FileVO vo) throws Exception {
		return  selectList("FileManageDAO.selectFileMngList", vo);
	}
	
	public int selectFileMngListCnt(FileVO vo) throws Exception {
		return  selectOne("FileManageDAO.selectFileMngListCnt", vo);
	}
	
	public void updateFileMng(FileVO vo) throws Exception {
		  update("FileManageDAO.updateFileMng", vo);
	}

	
	public EgovMap selectFileMng(FileVO vo) throws Exception {
		 return selectOne("FileManageDAO.selectFileMng", vo);
	}
